...
*/
        ...
        Coffret c2=new Coffret("Coffret2",true);
        Coffret c3=new Coffret("Coffret3",true);
        Coffret c4=new Coffret("Coffret4",true);
        Coffret c5=new Coffret("Coffret5",true);
        Coffret c6=new Coffret("Coffret6",true);
        ...
        Abonnes ab1=new Abonnes("AbNom1","AbNom1","1987-12-4","m",2500);
        Abonnes ab2=new Abonnes("AbNom2","AbNom2","2000-05-09","f",10000);
        Abonnes ab3=new Abonnes("AbNom3","AbNom3","1997-05-28","f",1000);
        Abonnes ab4=new Abonnes("AbNom4","AbNom4","2003-01-10","m",15000);
        Abonnes ab5=new Abonnes("AbNom5","AbNom5","1970-11-04","f",6000);
        Abonnes ab6=new Abonnes("AbNom6","AbNom6","1999-01-04","m",5030);
